...
class WhenNotNullRule(override val params: Array<String>, override val relyName: String?, override val relyValue: String?, override val isRely: Boolean = true) : BaseRule, WhenAble, RelyAble {
    companion object {
